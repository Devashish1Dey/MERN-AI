        ...
        <div className='md:hidden px-4 pb-4'>
          ...
          <div className='bg-white rounded-2xl border border-orange-100 shadow-lg p-4'>
            ...
            <div className='flex flex-col gap-3 mt-4'>
              <button onClick={()=> {navigate("/builder");setMenuOpen(false)}} className='w-full py-2.5 rounded-xl bg-gradient-to-r from-purple-500 to-emerald-500 text-white text-sm font-medium'>Builder</button>
              <button onClick={()=> {navigate("/billing");setMenuOpen(false)}} className='w-full py-2.5 rounded-xl border border-orange-100 bg-white text-gray-700 text-sm font-medium'>Billing</button>
            </div>
