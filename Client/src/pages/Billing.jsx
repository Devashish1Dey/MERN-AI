    ...
    const handlePay = async () => {
      try {
        ...
        const options = {
          ...
          handler: async (res) => {
            // console.log(res)
            const verifyRes = await axios.post(ServerUrl + "/api/billing/verify", res, {withCredentials: true})
    ...
    <div className="min-h-screen bg-[#f7f8fc] px-4 py-10">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-10">
          ...
          <div className="rounded-3xl p-8 bg-gradient-to-r from-purple-500 to-emerald-500 text-white shadow-lg">
            ...
            <button onClick={handlePay} disabled={user?.plan === "pro"} className={`mt-8 h-14 w-full rounded-2xl font-semibold transition ${user?.plan === "pro"
