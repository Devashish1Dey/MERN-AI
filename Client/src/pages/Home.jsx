  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] overflow-hidden">
      <section className="relative overflow-hidden px-4 sm:px-6 lg:px-8 pt-16 sm:pt-20 lg:pt-24 pb-20">
        <div className="absolute inset-0 bg-gradient-to-r from-purple-50 via-white to-emerald-50" />
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
            {STEPS.map((s, i) => (
              <div
                key={i}
                className="group bg-[#f8fafc] hover:bg-white border border-gray-100 rounded-[28px] p-7 transition-all hover:shadow-[0_15px_50px_rgba(0,0,0,0.06)]"
              >
